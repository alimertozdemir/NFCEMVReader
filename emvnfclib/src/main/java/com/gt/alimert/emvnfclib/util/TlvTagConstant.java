...
public final class TlvTagConstant {
    ...
    public static final byte[] CVM_LIST_TLV_TAG = {
            (byte) 0x8E
    ...
    public static final byte[] PAN_SEQUENCE_NUMBER_TLV_TAG = {
            (byte) 0x5F,
            (byte) 0x34
    ...
    public static final byte[] ISSUER_APPLICATION_DATA_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x10
    ...
    public static final byte[] IFD_SERIAL_NUMBER_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x1E
    ...
    public static final byte[] APPLICATION_CRYPTOGRAM_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x26
    ...
    public static final byte[] CVM_RESULTS_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x34
    }; //  Cardholder Verification Method (CVM) Results

    public static final byte[] UNPREDICTABLE_NUMBER_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x37
    }; // Unpredictable Number (UN)

    public static final byte[] TRANSACTION_SEQUENCE_COUNTER_TLV_TAG = {
            (byte) 0x9F,
            (byte) 0x41
    ...
    public static final byte[] DEDICATED_FILE_NAME_TLV_TAG = {
            (byte) 0x84
    }; // Dedicated File Name
